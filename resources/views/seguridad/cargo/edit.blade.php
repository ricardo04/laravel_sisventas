<div class="modal fade modal-slide-in-right" role="dialog" tabindex="-1" id="modal-editcargo-{{$cargo->idcargo}}">
    {{!!Form::model($cargo,['method'=>'PATCH','route'=>['cargo.update',$cargo->idcargo],'autocomplete'=>'off']) !!}}
    {{Form::token()}}
